package e04_listas.ejemplos_colas;

import e04_listas.ejemplos_colas.model.FifoEntry;
import e04_listas.ejemplos_colas.model.Pasajero;
...
public class PriorityQueueApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n\n");
        while(!cola2.isEmpty())
            System.out.println(cola2.poll().getEntry());
