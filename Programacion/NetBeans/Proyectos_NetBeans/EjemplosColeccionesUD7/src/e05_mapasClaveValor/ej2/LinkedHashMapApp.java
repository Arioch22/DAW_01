package e05_mapasClaveValor.ej2;
...
public class LinkedHashMapApp {
    ...
    public static void main(String[] args) {
        /*
            ...
            Nos permitirá almacenar productos y la cantidad de los mismos que queremos adquirir.
            Elegimos LinkedHashMap para mostrar al usuario los productos en el orden que los insertó.
            ...
            Tenemos varias alternativas de diseño del Map:
               ...
               3) Manejar 2 Map: Map<String, Producto>, para almacenar productos y otro Map<String, Integer> o Map<Producto, Integer> para el carrito
               4) Map<String, Integer>, con las referencias y la cantidades

            En una aplicación real, seguramente tengamos los productos en una base de datos, y la opción a elegir fuera la 4,
    ...
    /**
     * Método que decrementa en 1 el número de unidades del producto en el carrito. Si el número de unidades resultante es cero, se elimina.
     *
     * @param carrito
     */
    ...
    /**
     * Método que procesa el carrito para obtener el importe de la compra. El código no es estilo Java 8, para simplificar
     *
     * @param carrito
    ...
    public static void imprimirCarrito(Map<Producto, Integer> carrito) {
        if (carrito.size() >= 1) {
            ...
            for (Producto k : carrito.keySet()) {

                System.out.printf("Producto: %s (%s) -> Nº unidades: %s. Subtotal: %.2f\n", k.getPrecio(),
                        k.getReferencia(), carrito.get(k), k.getPrecio() * carrito.get(k));
            }
